...
void Director_Loop(Director_ThisState *thisState)
{
  ...
  case 5:
    ...
    if (_barrier3)
    {
      ...
      if (_barrier1)
      {
        ...
        while (1)
        {
          BSP_SPI_SetMotorPWM(0, 700, 1);
          BSP_SPI_SetMotorPWM(1, 700, 0);
          BSP_SPI_SetMotorPWM(2, 700, 1);
          BSP_SPI_SetMotorPWM(3, 700, 0);
          lineRes = BSP_Linefind_Read();
  ...
  case 10:
    ...
    while (1)
    {
      ...
      lineRes = BSP_Linefind_Read();
      if (lineRes.L1 + lineRes.L2 + lineRes.L3 + lineRes.L4 + lineRes.R1 + lineRes.R2 + lineRes.R3 + lineRes.R4 >= 5)
      {
        break;
      }
    }
  ...
  case 11:
    ...
    while (1)
    {
      BSP_SPI_SetMotorPWM(0, 750, 1);
      BSP_SPI_SetMotorPWM(1, 750, 0);
      BSP_SPI_SetMotorPWM(2, 750, 1);
      BSP_SPI_SetMotorPWM(3, 750, 0);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 150 && lineRes.L1 == 0 && lineRes.R1 == 0)
      {
        break;
      }
    }
    ...
    {
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 100 && lineRes.L1 + lineRes.L2 + lineRes.L3 + lineRes.L4 + lineRes.R1 + lineRes.R2 + lineRes.R3 + lineRes.R4 <= 4)
      {
        break;
      }
    }
    ...
    while (1)
    {
      _Director_AggressiveLineFollow();
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 200 && lineRes.L1 + lineRes.L2 + lineRes.L3 + lineRes.L4 + lineRes.R1 + lineRes.R2 + lineRes.R3 + lineRes.R4 == 0)
      {
        break;
      }
    }
  ...
  case 22:
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 650, 0);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 500 && lineRes.R1 == 1 && lineRes.R2 == 1 && lineRes.L1 == 0)
      {
        break;
      }
    }
  ...
  case 21:
    ...
    while (1)
    {
      ...
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 100 && lineRes.L1 == 0 && lineRes.R1 == 0)
      {
        break;
      }
    }
  ...
  case 33:
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 1);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 100 && lineRes.L1 == 1 && lineRes.R1 == 1 && lineRes.R3 == 0)
      {
        break;
      }
    }
  ...
  case 34:
    ...
    while (1)
    {
      _Director_AggressiveLineFollow();
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 4000 && lineRes.R3 == 1 && lineRes.R4 == 1)
      {
        break;
      }
    }
  ...
  case 35:
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 1);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 300 && lineRes.L1 == 1 && lineRes.L2 == 1 && lineRes.R2 == 0)
      {
        break;
      }
    }
  ...
  case 36:
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 0);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 300 && lineRes.R2 == 1 && lineRes.R1 == 1 && lineRes.L2 == 0)
      {
        break;
      }
    }
  ...
  case 38:
    ...
    while (1)
    {
      _Director_LoopLineFollow();
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 200 && lineRes.R4 == 1 && lineRes.R3 == 1)
      {
        break;
      }
    }
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 1);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 250 && lineRes.L1 == 1 && lineRes.R1 == 1 && lineRes.R3 == 0)
      {
        break;
      }
    }
  ...
  case 39:
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 1);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 250 && lineRes.R2 == 1 && lineRes.R1 == 1)
      {
        break;
      }
    }
    ...
    while (1)
    {
      ...
      BSP_SPI_SetMotorPWM(3, 600, 0);
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 500 && lineRes.L3 == 1 && lineRes.L4 == 1)
      {
        break;
      }
    }
    ...
    while (1)
    {
      _Director_AggressiveLineFollow();
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 4000 && lineRes.L1 + lineRes.L2 + lineRes.L3 + lineRes.L4 + lineRes.R1 + lineRes.R2 + lineRes.R3 + lineRes.R4 == 0)
      {
        break;
      }
    }
  ...
  case 46:
    ...
    while (1)
    {
      _Director_AggressiveLineFollow();
      lineRes = BSP_Linefind_Read();
      if (getSysPeriod() - _c0_timestamp >= 300 && lineRes.L1 + lineRes.L2 + lineRes.L3 + lineRes.L4 + lineRes.R1 + lineRes.R2 + lineRes.R3 + lineRes.R4 == 0)
      {
        break;
      }
    }
  ...
  case 49:
    BSP_LEDBUZ_Flash(BSP_LEDBUZ_BUZ, 1000, 3);
    _Director_PosShift(thisState, _route[thisState->steps + 1]);
    thisState->steps++;
    break;
